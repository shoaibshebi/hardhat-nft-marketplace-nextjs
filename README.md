...
<br/>
<p align="center">
<img src="./public/hero here.png" width="500" alt="Hardhat NextJS Marketplace">
</a>
<br/>
...
```
git clone https://github.com/shoaibshebi/hardhat-nft-marketplace-backend.git
cd hardhat-nft-marketplace-backend
yarn
```
...
```
git clone https://github.com/shoaibshebi/hardhat-nft-marketplace-next-js.git
cd hardhat-nft-marketplace-next-js
yarn
```
...
# Thanks
- Readme credits: https://github.com/PatrickAlphaC
